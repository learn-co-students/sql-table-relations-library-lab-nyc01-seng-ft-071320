...
def select_name_and_series_subgenres_of_authors
  ...
  #--GROUP BY AUTHORS.NAME ORDER BY AUTHORS.NAME DESC LIMIT 1 NOT NEEDED
end
...
def select_series_title_with_most_human_characters
  ...
  # "SELECT SERIES.TITLE, COUNT(*) FROM SERIES JOIN AUTHORS ON SERIES.AUTHOR_ID=AUTHORS.ID JOIN CHARACTERS 
  # ON AUTHORS.ID=CHARACTERS.AUTHOR_ID WHERE CHARACTERS.SPECIES ='human' GROUP BY TITLE ORDER BY COUNT (*);"
end
